...
export const pubManagerAnalyticsReducer = (state = initialState, action) => {
    switch (action.type) {
        case AnalyticsTypes.GET_DOORSTAFF_ANALYTICS:
            return {
                ...state,
                doorstaff: action.data,
            }
        case AnalyticsTypes.GET_COSTS_ANALYTICS:
            return {
                ...state,
                costs: action.data,
            }
        case AnalyticsTypes.SET_DATE_FROM_ANALYTICS:
            return {
                ...state, dateFrom: action.data
            }
        case AnalyticsTypes.SET_DATE_TO_ANALYTICS:
            return {
                ...state, dateTo: action.data
            }
        case AnalyticsTypes.SET_CURRENT_TYPE: {
            return {
