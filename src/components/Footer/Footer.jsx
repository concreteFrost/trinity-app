          ...
          <nav>
            <div className={s.grid}>
              <div className={s.cocoon}>
                ...
                <div>
                  <a href="https://cocoon.technology/">
                    {" "}
                    ©Cocoon Technology 2023
                  </a>
                </div>
              </div>
              <div className={s.copyright}>
                <div>
                  {" "}
                  <a href="https://trinity.jdwint.local/sif/autobill.pdf">
      ...
      {isHelpVisible ? (
        <div className={s.help_container}>
          <div className={s.help_modal_window}>
            <div className={s.help_close_btn}>
              <button
                onClick={() => {
            ...
            <div className={s.help_modal_message}>
              <h3>CONTACT</h3>
              <div>
                <span>Phone:</span>01923 477771
              </div>
              <div>
                <span>Email:</span>{" "}
                <a href={`mailto:ithelpdeskrequests@jdwetherspoon.co.uk`}>
                  ithelpdeskrequests@jdwetherspoon.co.uk
                </a>
              </div>
            </div>
          </div>
