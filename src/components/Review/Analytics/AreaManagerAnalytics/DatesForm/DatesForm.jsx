...
import {
  SetAreaManagerAnalyticsDateFrom,
  SetAreaManagerAnalyticsDateTo,
      ...
      <form onSubmit={(e) => Submit(e)}>
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              dispatch(SetAreaManagerAnalyticsDateFrom(e.target.value));
            }}
          ></input>
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              dispatch(SetAreaManagerAnalyticsDateTo(e.target.value));
            }}
          />
        </div>
